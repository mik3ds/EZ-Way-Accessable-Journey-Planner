...
public class SlidingPanelClass extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMapview.getMapAsync(new OnMapReadyCallback() {
            ...
            private void addStations(MapboxMap mapboxMap) {
                ...
                IconFactory iconFactory = IconFactory.getInstance(SlidingPanelClass.this);
                Drawable iconDrawable = ContextCompat.getDrawable(SlidingPanelClass.this, R.drawable.train);
